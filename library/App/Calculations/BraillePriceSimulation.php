 ...
 * @package Embalagem
 * 
 * Ultima revisao - 01/07/2014
 */
class App_Calculations_BraillePriceSimulation
{
    ...
    function __construct ()
    {
	    ...
	    $this->dbtable = new App_User_Service_BrailleSimulation();
     ...
     * @return string
     */
    private function _getTexto ()
    {
		return $this->texto;
    }


	public function setUnidadesDoCortante($units)
	{
		$this->units = $units;
	}
    ...
    public function formatTextforCount ()
    {
        ...
        $text = stripcslashes(strtolower($this->_getTexto()));
    ...
    {
		$unidadesCortante = intval($this->getUnidadesDoCortante());
